...
if CLIENT then
	...
	net.Receive( "meshQueueClear", function()
	...
	hook.Add("PlayerBindPress", "wire_mesh_scale_setup", function() -- For initial spawn
		for _, ent in ipairs(ents.FindByClass("gmod_wire_mesh")) do
		...
		hook.Remove("PlayerBindPress", "wire_mesh_scale_setup")
	end)
	...
	net.Receive("wire_meshs_clip", function(netlen)
		while true do
	...
	net.Receive("wire_meshs_set_scale", function(netlen)
	...
	net.Receive("wire_meshs_set_bone_scale", function(netlen)
		local index = net.ReadUInt(16)
	...
	net.Receive("wire_meshs_set_visible", function(netlen)
		local index = net.ReadUInt(16)
	...
	net.Receive("wire_meshs_set_player_color", function(netlen)
		local index = net.ReadUInt(16)
	...
	concommand.Add("wire_meshs_block_client",
	...
	concommand.Add("wire_meshs_unblock_client",
		function(ply, command, args)
			local toblock = checkSteamid(args[1])
			if not toblock then print("Invalid SteamId") return end
	...
	hook.Add("NetworkEntityCreated", "wire_mesh_rescale", function(ent)
